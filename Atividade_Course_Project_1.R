...
#### graficos usando o pacote ggplot2

##Seguindo as atividades
...
ggplot(steps, aes(x = steps)) +
  geom_histogram(fill = "pink1", col=I("black"), binwidth = 1000) +
...
ggplot(filled_steps, aes(x = steps)) +
  geom_histogram(fill = "red3",colour="Black",binwidth = 1000) +
